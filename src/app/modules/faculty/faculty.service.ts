...
const assignCourses = async (
  ...
  const assingCoursesData = await prisma.courseFaculty.findMany({
    where: {
      facultyId: id,
    },
    include: {
...
const removeCourses = async (
  ...
  const courseFacultiesData = await prisma.courseFaculty.findMany({
    where: {
      courseId: id,
    },
    include: {
